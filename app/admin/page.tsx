...
export default function AdminProjectsPage() {
  ...
  const handleCreateProject = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setActionError(getErrorMessage(error, "Could not create the project."));
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-8">
        ...
        {actionError && (
          <div className="bg-red-50 border border-red-200 text-red-700 text-sm p-3 rounded mb-4">{actionError}</div>
        )}
