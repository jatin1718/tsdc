...
export default function ProjectDetailPage() {
  ...
  useEffect(() => {
    ...
    const fetchProject = async () => {
      try {
        ...
        else setLoadError("Project not found.");
      } catch (error) {
        console.error("Error loading project:", error);
        setLoadError(getErrorMessage(error, "Could not load this project."));
      }
    };
    fetchProject();
  }, [projectId, user, userData, loading]);
  ...
  useEffect(() => {
    ...
    const fetchTeammates = async () => {
      ...
      try {
        ...
        setActionError(getErrorMessage(error, "Could not load teammates."));
      }
    };
    fetchTeammates();
  ...
  const handleSubmitTask = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setActionError(getErrorMessage(error, "Could not save the task."));
    }
  };
  ...
  const handleDeleteTask = async (taskId: string) => {
    ...
    try {
      ...
      setActionError(getErrorMessage(error, "Could not delete the task."));
    }
  };
  ...
  const handleUpdateProject = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setActionError(getErrorMessage(error, "Could not update the project."));
    }
  };
  ...
  const handleDeleteProject = async () => {
    ...
    try {
      ...
      setActionError(getErrorMessage(error, "Could not delete the project."));
    }
  };
